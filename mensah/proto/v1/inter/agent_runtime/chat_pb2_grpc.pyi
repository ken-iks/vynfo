...
class ChatServiceStub:
    ...
    GenerateTitle: _grpc.UnaryUnaryMultiCallable[
        _chat_pb2.GenerateTitleRequest, _chat_pb2.GenerateTitleResponse
    ]
...
class ChatServiceAsyncStub(ChatServiceStub):
    ...
    GenerateTitle: _aio.UnaryUnaryMultiCallable[
        _chat_pb2.GenerateTitleRequest, _chat_pb2.GenerateTitleResponse
    ]  # type: ignore[assignment]
...
class ChatServiceServicer(metaclass=_abc_1.ABCMeta):
    ...
    def GenerateTitle(
        ...
        _chat_pb2.GenerateTitleResponse, _abc.Awaitable[_chat_pb2.GenerateTitleResponse]
    ]: ...
